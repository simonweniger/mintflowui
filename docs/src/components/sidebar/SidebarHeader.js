...
function SidebarMobileOnly() {
  return (
    <div className="rounded-lg shadow bg-base-100 h-full drawer ">
      <input id="my-drawer2" type="checkbox" className="drawer-toggle" /> 
      <div className="drawer-content">
      <div class="h-screen flex overflow-hidden bg-base-100 rounded-xl">
      <div className="hidden h-screen lg:block my-4 relative w-44">
        ...
        <div class="flex flex-col w-0 flex-1 overflow-hidden">
            <div class="relative z-10 flex-shrink-0 flex h-16 bg-base-100 mr-2">
              <input id="my-drawer2" type="checkbox" className="drawer-toggle" /> 
              <div className="flex lg:hidden justify-center drawer-content">
                ...
                <div class="flex-1 px-4 flex justify-between">
                  ...
                  <div class="ml-4 flex items-center md:ml-6">
                    <button class="bg-base-100 p-1 rounded-full text-gray-400 hover:text-gray-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                    ...
                    <div class="ml-3 relative">
                      <div>
                        <button type="button" class="max-w-xs bg-base-100 flex items-center text-sm rounded-full focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500" id="user-menu-button" aria-expanded="false" aria-haspopup="true">
        ...
        <main class="drawer-content m-4 mt-0 bg-base-200 rounded-xl flex-1 relative overflow-y-auto focus:outline-none">
        <div class="py-6">
