  ...
  return (
        <div className="overflow-auto h-screen pb-44 pt-2 pr-2 pl-2 md:pt-0 md:pr-0 md:pl-0">
                ...
                <div className="mb-4 bg-base-100 p-6 rounded-xl">
                    ...
                    <div className="mb-4 bg-base-100 p-6 rounded-xl">
                        <h3 className="font-heading h2">Heading 2</h3>                                    
                    </div>
                    <div className="mb-4 bg-base-100 p-6 rounded-xl">
                        <h4 className="font-heading h3">Heading 3</h4>                                 
                    </div>
                    <div className="mb-4 bg-base-100 p-6 rounded-xl">
                        <h5 className="font-heading h4">Heading 4</h5>                                   
                    </div>
                    <div className="mb-4 bg-base-100 p-6 rounded-xl">
                        <h6 className="font-heading h5">Heading 5</h6>
                    </div>
                    <div className="mb-4 bg-base-100 p-6 rounded-xl">
